...
```
# public/robots.txt (or dynamic robots in app/robots.ts) — use your *public* Studio path from
# NEXT_PUBLIC_SANITY_STUDIO_BASE_PATH (e.g. default /studio in examples, not the internal /sanity-studio mount)
User-agent: *
Allow: /
Disallow: /api/
Disallow: /studio/
